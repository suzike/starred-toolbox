...
<table width="100%">
<tr><td width="40%"><a href="#ai-agent-与编码智能体">AI Agent 与编码智能体</a></td><td width="10%" align="right">10</td><td width="40%"><a href="#agent-扩展skills-与工具协议">Agent 扩展、Skills 与工具协议</a></td><td width="10%" align="right">5</td></tr>
<tr><td width="40%"><a href="#知识库rag-与记忆">知识库、RAG 与记忆</a></td><td width="10%" align="right">4</td><td width="40%"><a href="#matlab-simulink-与基于模型的设计">MATLAB / Simulink 与基于模型的设计</a></td><td width="10%" align="right">7</td></tr>
<tr><td width="40%"><a href="#汽车电子车载测试与控制">汽车电子、车载测试与控制</a></td><td width="10%" align="right">7</td><td width="40%"><a href="#内容创作与多媒体生成">内容创作与多媒体生成</a></td><td width="10%" align="right">6</td></tr>
<tr><td width="40%"><a href="#信息聚合与效率工具">信息聚合与效率工具</a></td><td width="10%" align="right">4</td><td width="40%"><a href="#编程学习与计算机基础">编程学习与计算机基础</a></td><td width="10%" align="right">15</td></tr>
<tr><td width="40%"><a href="#机器学习与深度学习框架">机器学习与深度学习框架</a></td><td width="10%" align="right">3</td><td width="40%"><a href="#工程方法论与研发流程">工程方法论与研发流程</a></td><td width="10%" align="right">2</td></tr>
<tr><td width="40%"><a href="#其他">其他</a></td><td width="10%" align="right">2</td><td width="40%"></td><td width="10%"></td></tr>
</table>
